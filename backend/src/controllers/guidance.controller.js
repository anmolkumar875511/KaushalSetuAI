...
export const getJobReadinessReports = asyncHandler(async (req, res) => {
    ...
    if (reports.length === 0) {
        return res
            .status(200)
            .json(new apiResponse(200, 'No job readiness reports found', []));
    }
...
export const getInterestGuides = asyncHandler(async (req, res) => {
    ...
    if (guides.length === 0) {
        return res
            .status(200)
            .json(new apiResponse(200, 'No interest guides found', []));
    }
...
export const getFreelanceGuides = asyncHandler(async (req, res) => {
    ...
    if (guides.length === 0) {
        return res
            .status(200)
            .json(new apiResponse(200, 'No freelance guides found', []));
    }
