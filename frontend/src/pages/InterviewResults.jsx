...
import { Loader2, Target, TrendingUp, AlertCircle, RotateCcw, ChevronLeft, Trophy } from 'lucide-react';
    ...
    if (loading) {
        return (
            <div style={{ minHeight: '100vh', backgroundColor: colors.bgPage, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Loader2 size={20} style={{ color: colors.textSub, animation: 'spin 1s linear infinite' }} />
            </div>
        );
    }
    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: colors.bgPage, fontFamily: font.body }}>
            ...
            <div style={{ maxWidth: 760, margin: '0 auto', padding: 'clamp(2rem, 5vw, 3rem) 1.25rem' }}>
                ...
                {/* Back */}
                <button onClick={() => navigate('/past_interviews')} style={{ ...ghostBtn, marginBottom: '1.5rem' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem', animation: 'fadeUp 0.3s ease' }}>
                    ...
                    <p style={{ fontSize: '0.875rem', color: colors.textSub, margin: '0 0 4px' }}>
                        {interview.jobRole} · <span style={{ textTransform: 'capitalize' }}>{interview.experienceLevel}</span>
                    </p>
                    {durationStr && (
                ...
                <div style={{ display: 'flex', gap: '0.75rem', marginTop: '2rem', flexWrap: 'wrap', animation: 'fadeUp 0.3s ease 0.2s both' }}>
                    <button onClick={() => navigate('/mock-interview')} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '0.6rem 1.4rem', border: 'none', borderRadius: radius.md, backgroundColor: colors.primary, color: '#fff', fontSize: '0.85rem', fontWeight: 700, cursor: 'pointer', fontFamily: font.body }}>
